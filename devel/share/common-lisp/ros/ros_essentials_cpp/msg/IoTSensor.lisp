...
(cl:defmethod cl:initialize-instance :after ((m <IoTSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IoTSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_essentials_cpp-msg:<IoTSensor> is deprecated: use ros_essentials_cpp-msg:IoTSensor instead.")))
